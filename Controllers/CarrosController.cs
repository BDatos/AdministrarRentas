...
namespace AdministarRenta.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Matricula,Marca,Modelo,capacidad")] Carro carro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Matricula,Marca,Modelo,capacidad")] Carro carro)
        {
            if (id != carro.Matricula)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!CarroExists(carro.Matricula))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Carro.Any(e => e.Matricula == id);
        }
    }
}
